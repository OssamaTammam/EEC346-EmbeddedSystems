...
; 0000 0020 TCNT0=0x94;
	LDI  R30,LOW(148)
	OUT  0x32,R30
; 0000 0021 // Place your code here
; 0000 0022 PORTB.0 ^= (1<<PORTB0);
	LDI  R26,0
	SBIC 0x18,0
	LDI  R26,1
	LDI  R30,LOW(1)
...
; 0000 002C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 002D DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 002E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 0033 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(1)
	OUT  0x17,R30
...
; 0000 003E // Function: Bit7=Out Bit6=In Bit5=Out Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 003F DDRD=(1<<DDD7) | (0<<DDD6) | (1<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(160)
	OUT  0x11,R30
; 0000 0040 // State: Bit7=0 Bit6=T Bit5=0 Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0051 // OC1A output: Toggle on compare match
...
; 0000 0057 // OC1A Period: 2 s Width: 1 s
...
; 0000 005C TCCR1A=(0<<COM1A1) | (1<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(64)
	OUT  0x2F,R30
...
; 0000 0061 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0062 OCR1AH=0xA8;
	LDI  R30,LOW(168)
	OUT  0x2B,R30
; 0000 0063 OCR1AL=0xBF;
	LDI  R30,LOW(191)
	OUT  0x2A,R30
...
; 0000 0069 // Clock value: 172.800 kHz
; 0000 006A // Mode: Fast PWM top=0xFF
; 0000 006B // OC2 output: Non-Inverted PWM
; 0000 006C // Timer Period: 1.4815 ms
; 0000 006D // Output Pulse(s):
; 0000 006E // OC2 Period: 1.4815 ms Width: 1.1097 ms
; 0000 006F ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0070 TCCR2=(1<<PWM2) | (1<<COM21) | (0<<COM20) | (1<<CTC2) | (1<<CS22) | (0<<CS21) | (0<<CS20);
	LDI  R30,LOW(108)
	OUT  0x25,R30
...
; 0000 0075 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0076 
