...
;	data -> Y+0
	LD   R30,Y
	OUT  0xF,R30
; 0000 0022     while (SPSR&(1<<SPIF)==0);
_0x3:
	IN   R30,0xE
	ANDI R30,LOW(0x0)
	BRNE _0x3
; 0000 0023     return SPDR;
	IN   R30,0xF
	ADIW R28,1
	RET
; 0000 0024 }
...
; 0000 0031 PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(255)
	OUT  0x1B,R30
; 0000 0032 
; 0000 0033 // Port B initialization
; 0000 0034 // Function: Bit7=Out Bit6=In Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0035 DDRB=(1<<DDB7) | (0<<DDB6) | (1<<DDB5) | (1<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(176)
	OUT  0x17,R30
; 0000 0036 // State: Bit7=0 Bit6=T Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0041 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
; 0000 0042 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0043 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	OUT  0x12,R30
; 0000 0044 
; 0000 0045 // SPI initialization
; 0000 0046 // SPI Type: Master
; 0000 0047 // SPI Clock Rate: 691.200 kHz
; 0000 0048 // SPI Clock Phase: Cycle Start
; 0000 0049 // SPI Clock Polarity: Low
; 0000 004A // SPI Data Order: LSB First
; 0000 004B SPCR=(0<<SPIE) | (1<<SPE) | (1<<DORD) | (1<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (1<<SPR0);
	LDI  R30,LOW(113)
	OUT  0xD,R30
; 0000 004C SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 004D 
; 0000 004E while (1)
